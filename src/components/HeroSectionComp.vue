<template>
  <div class="lg:flex lg:flex-row lg:justify-between lg:h-[90vh] ">
    ...
    >
      <img
        class=" hidden lg:flex lg:absolute lg:top-0 lg:w-80  lg:ml-10 lg:z-10 lg:max-h-[300px] lg:mt-[250px] lg:border-2 lg:border-darling-purple xl:max-h-[300px] xl:object-cover xl:min-w-[250px] xl:mt-[250px] 2xl:mt-[250px] 2xl:min-w-[500px]"
         :src="urlFor(heroImages.image1)"
        alt="image1"
      />
      <img
        class=" hidden lg:flex lg:absolute lg:top-0 z-0 lg:w-80 lg:max-h-[300px] lg:border-2 lg:border-darling-purple xl:min-w-[300px] xl:object-cover xl:max-h-[300px] 2xl:min-w-[500px]"
        :src="urlFor(heroImages.image2)"
        alt="image2"
      />
      <img
        class="hidden lg:flex lg:absolute lg:top-0 lg:ml-[400px] lg:max-h-[300px] lg:z-10 lg:w-72 lg:mt-[100px] lg:border-2 lg:border-darling-purple xl:min-w-[120px] xl:object-cover xl:ml-[400px] xl:mt-[100px] 2xl:min-w-[300px] 2xl:ml-[650px]"
